...
for(i=1; i<=l; i++){
  ...
  println("getProb(" + ssi + ")=" + si.getProb(ssi))
  ...
  ai.setEvidence(aai)
  println("getProb(" + aai + ")=" + ai.getProb(aai)  + " Alto:" + valuesA[aai])
  ...
  ti.setEvidence(tti)
  println("getProb(" + tti + ")=" + ti.getProb(tti) + " Tenor:" + valuesT[tti])
  ...
  bi.setEvidence(bbi)
  println("getProb(" + bbi + ")=" + bi.getProb(bbi) + " Bass:" + valuesB[bbi])
